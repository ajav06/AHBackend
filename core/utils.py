...
BASE_URL = 'https://caracas-against-humanity.herokuapp.com/api'
...
def post(url: str, data: dict, token: str = None) -> Dict[Any, Any]:
    """
    ...
    return request('POST', BASE_URL + url, data=data)


def get(url: str, token: str = None) -> Dict[Any, Any]:
    """
